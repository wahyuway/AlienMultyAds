...
public class AliendroidIntertitial {
    ...
    public static void LoadIntertitialUnity(Activity activity, String selectAds,String idIntertitial, String idBackupIntertitial) {
        ...
        switch (selectAds) {
            ...
            case "APPLOVIN-M":
                ...
                break;
            case "MOPUB":
                mInterstitial = new MoPubInterstitial(activity, idBackupIntertitial);
                mInterstitial.load();
                break;
            case "IRON":
    ...
    public static void LoadIntertitialUnityMediation(Activity activity, String selectAdsBackup,String idIntertitial, String idBackupIntertitial) {
    ...
    public static void ShowIntertitialUnityMediation(Activity activity, String selectAdsBackup, String idIntertitial, String idIntertitialBackup,
                                            int interval) {
        if (counter >= interval) {
            if (unityInterstitialAd != null) {
                final IInterstitialAdShowListener showListener = new IInterstitialAdShowListener() {
